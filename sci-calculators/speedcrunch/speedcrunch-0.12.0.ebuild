...
PLOCALES="ar ca_ES cs_CZ da de_DE el en_GB en_US es_AR es_ES et_EE eu_ES fi_FI
	fr_FR he_IL hu_HU id_ID it_IT ja_JP ko_KR lt lv_LV nb_NO nl_NL pl_PL
	pt_BR pt_PT ro_RO ru_RU sk sv_SE tr_TR uz_Latn_UZ vi zh_CN"
...
SRC_URI="https://bitbucket.org/${USER}/${PN}/get/release-${PV}.tar.gz -> ${P}.tar.gz"
