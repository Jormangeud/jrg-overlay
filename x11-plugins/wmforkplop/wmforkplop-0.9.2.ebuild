...
DESCRIPTION="wmforkplop monitors the forking activity of the kernel and displays a list of the most cpu-consuming processes."
...
src_install ()
{
	...
	if use gkrellm; then
		...
		# gkrellm plugin ebuilds do it the same way
